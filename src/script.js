...
const editProfilePopup = new PopupWithForm("#popup__section-edit",{
  handleSubmit: (info) => {
...
const addCardPopup = new PopupWithForm("#popup__section-add",{
  handleSubmit:(item)=>{
...
function createCard(data) { 
  const card = new Card(data, cardTemplateSelector, popupWithImage.open);
